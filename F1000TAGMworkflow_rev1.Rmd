...
```{r e14pca1, fig.cap = "The first two principal component of a mouse embryonic stem cell dataset [@Breckels:2016]. Each pointer represents a protein and marker proteins are coloured according to their localisation. Proteins with unknown localisation are coloured grey.", out.width = '70%'}
plot2D(E14TG2aR)
...
```{r e14ellipse, out.width = '100%', fig.width = 10, fig.height = 8, fig.cap = "PCA plot with probability ellipses along PC 1 and 2 (left) and PC 1 and 4 (right). The ellipses show the component-conditional densities obtained from the fitted model evaluated at $\theta_{\text{MAP}}$"}
par(mfrow = c(2, 1))
