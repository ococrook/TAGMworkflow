...
```{r mcmcCartoon, fig.width = 6, fig.height = 6, fig.cap = "A schematic figure of MCMC sampling", message = FALSE, echo = FALSE, cache = TRUE}
set.seed(2)
...
p2 <- plot(e14Tagm_converged_pooled, "P32921")
library(patchwork)
p1 / p2
```
...
will help spatial proteomics practitioners to apply our method and
