...
```{r e14pca1, fig.cap = "First two principal components of mouse stem cell data before (left) and after (right) normalisation..", fig.width = 10, fig.height = 5}
par(mfrow = c(1, 2))
plot2D(E14TG2aR)
...
```{r MAPconverge}
plot(mappars@posteriors$logposterior, type = "b", col = "blue",
