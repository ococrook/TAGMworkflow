...
Bayesian analysis requires users to specify a prior information about the parameters.
This potentially appears an impossible task; however, good default options 
...
following default choices work well in practice. The priors also provide
...
A normal inverse-Wishart prior is place on the normally distributed
